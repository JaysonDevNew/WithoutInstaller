...
if "%PHPBIN%" == "" set PHPBIN=\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php\phpunit" %*
