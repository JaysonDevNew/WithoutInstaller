...
FOR %%x IN ("\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\markj\Videos\GymXFit_V5.0\GymXFit-FinalBoss\Capstone Project\bin\Debug\xampp\php\php.exe"
GOTO :INSTALLED
